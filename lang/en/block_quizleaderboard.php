...
$string['config_showstudentid']    = 'Show student ID number (in full page mode)';
$string['config_showstudentid_help'] = 'Display a column with each student\'s ID number (their idnumber profile field) on the full leaderboard page. The compact sidebar block never shows this column, as there is not room for it. If "Anonymise student names" is also enabled, anonymising wins and the ID number column is hidden, since an ID number would identify a student just as readily as their name.';
